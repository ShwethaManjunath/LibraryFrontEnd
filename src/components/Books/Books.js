...
export class BooksPage extends Component{
    ...
    componentDidMount(){
        this.props.fetchBooks().then(res => this.setState({localbooks:[...this.props.books],tempbooks:[...this.props.books]}));
                ...
                <section className="section pb-3 text-center">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-9">
                            <div className="row">
                                <BooksList books={this.state.tempbooks} clicked={this.toggleBook} />
                            </div>
